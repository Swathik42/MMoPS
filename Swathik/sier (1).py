...
def s_i_r_model(a, b, p, c, q, d, e, r, s, f, g, initial_s, initial_iA, initial_iS, time):
  ...
  s_smooth = rbf(t_new)
  plt.plot(t_new, s_smooth, label='susceptible')
  #plt.scatter (time, susceptible);
  
  rbf = Rbf(time, infected, function = 'thin_plate', smooth = 0.001)
  s_smooth = rbf(t_new)
  plt.plot(t_new, s_smooth, label='infected')
  #plt.scatter (time, infected, label='infected');
  
  rbf = Rbf(time, recovered, function = 'thin_plate', smooth = 0.001)
  s_smooth = rbf(t_new)
  plt.plot(t_new, s_smooth, label='recovered')
  #plt.scatter (time, recovered);

  rbf = Rbf(time, hospitalized, function = 'thin_plate', smooth = 0.001)
  s_smooth = rbf(t_new)
  plt.plot(t_new, s_smooth, label='hospitalized')
  #plt.scatter (time, hospitalized);
  rbf = Rbf(time, dead, function = 'thin_plate', smooth = 0.001)
  s_smooth = rbf(t_new)
  plt.plot(t_new, s_smooth, label='dead')
  #plt.scatter (time, dead);
